...
class Optimizer_Adam:
    def __init__(
        self, learning_rate=0.001, decay=0., epsilon=1e-7, beta_1=0.9, beta_2=0.999
    ):
        self.learning_rate = learning_rate
        self.current_learning_rate = learning_rate
        self.decay = decay
    ...
    def update_params(self, layer):
        ...
        bias_cache_corrected = (
            self.beta_2 * layer.bias_cache / (1 - self.beta_2 ** (self.iterations + 1))
        )
